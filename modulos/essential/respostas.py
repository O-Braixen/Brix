...
for arquivo in os.listdir("responses"):
    caminho_arquivo = os.path.join("responses", arquivo)
...
class Res:
  ...
  async def print_brix(comando,interaction,condicao=None):
    ...
    if 'ban' in usuario_banco:  # Verifica se 'servidor' não é None ou vazio
        ...
        try:
            # URL do webhook
            webhook = discord.SyncWebhook.from_url("https://discord.com/api/webhooks/1336298345513091115/cRs9_jdeG-P3-X0giyjYOQvPxRUkEvax3YbB3Ha0xDt1y4EpKKASCrlWfcWmDBuAMQkg")
