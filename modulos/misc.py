...
#COMANDO USUARIO AVATAR SLASH
  ...
  async def useravatar(self,interaction: discord.Integration,membro: discord.User=None):
...
#COMANDO USUARIO INFO SLASH
  ...
  @app_commands.describe(membro="informe um membro")
  async def userinfo(self,interaction: discord.Integration,membro: discord.User=None):
...
#COMANDO USUARIO ABRAÇO SLASH
  ...
  @app_commands.describe(membro="informe um membro")
  async def userabraco(self,interaction: discord.Integration,membro: discord.User):
...
#COMANDO USUARIO ABRAÇO SLASH
  ...
  async def useratack(self,interaction: discord.Integration,membro: discord.User):
...
#COMANDO USUARIO ABRAÇO SLASH
  ...
  @app_commands.describe(membro="informe um membro")
  async def usercarinho(self,interaction: discord.Integration,membro: discord.User):
...
#COMANDO USUARIO CAFUNÉ SLASH
  ...
  @app_commands.describe(membro="informe um membro")
  async def usercafune(self,interaction: discord.Integration,membro: discord.User):
